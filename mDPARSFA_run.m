% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   DPARSFA_run的免并行，免reslice版本；
%   通过替换所有parfor为for，并注释掉parpool语句，禁止了并行循环！
%   通过查找Resample Masks、Check if the ROI mask is appropriate处，取消了mask
%   可以原函数，或自行reslice得到BrainMask和FCROI mask，并存于Masks文件夹中，以备使用！
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Error, AutoDataProcessParameter]=mDPARSFA_run(AutoDataProcessParameter,WorkingDir,SubjectListFile,IsAllowGUI)
